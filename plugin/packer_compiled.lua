...
_G.packer_plugins = {
  ...
  ["nvim-ts-autotag"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/Users/david/.local/share/nvim/site/pack/packer/opt/nvim-ts-autotag",
  ...
  ["vim-ReplaceWithRegister"] = {
    loaded = true,
    path = "/Users/david/.local/share/nvim/site/pack/packer/start/vim-ReplaceWithRegister",
